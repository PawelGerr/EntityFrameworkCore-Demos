...
namespace EntityFramework.Demo.SchemaChange
{
	public class DbSchemaAwareMigrationAssembly : MigrationsAssembly
	{
		...
		/// <inheritdoc />
		public DbSchemaAwareMigrationAssembly(ICurrentDbContext currentContext, IDbContextOptions options, IMigrationsIdGenerator idGenerator, IDiagnosticsLogger<DbLoggerCategory.Migrations> logger)
